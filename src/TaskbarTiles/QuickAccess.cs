...
namespace TaskbarTiles
{
    ...
    sealed partial class Switcher
    {
        ...
        void PaintQuickAccess(Graphics g)
        {
            ...
            PaintQuickButton(g, quick.Search, -12, "Search apps, settings and files…", "search");
        ...
        bool QuickAccessKey(Keys keys)
        {
            ...
            if (keys == (Keys.Control | Keys.Shift | Keys.R) && options.RecentAppsButton) { ShowRecentApps(); return true; }
